...
## Core
SIGT customizado p/ campanha **Kiribamba · Avante 70 · Dep. Estadual BA** (eleição 04/10/2026, base Vitória da Conquista + 31 municípios microrregião).
...
Painel inicial usa CampanhaHero + ConsultorBriefing (estilo Stenio Fernando consultor). Nunca mockar dados.

## Memories
- [Avante brand](mem://design/avante-kiribamba-brand) — Cores, tipografia, classes utilitárias .brand-* e regras de uso
